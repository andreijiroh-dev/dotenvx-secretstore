...
import _runServ from "@dotenvx/dotenvx/src/lib/services/run.js"
const { Run } = _runServ
import _conventions from "@dotenvx/dotenvx/src/lib/helpers/conventions.js"
const { conventions }= _conventions

export async function executeCommand(commandArgs, env) {
    const signals = [
